  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className="pt-10 pb-6 mx-auto xl:w-3/5 lg:ml-auto lg:pt-20 lg:pl-20 lg:pb-16">
        <h2 className={styles.heading}>Why buy from us</h2>
        ...
        <div className={styles.features}>
          <div className={styles.feature}>
            <div>
              <Image alt="logo" src={madeInUsa} width={34} height={34} />
            </div>
            <h3 className={styles.featureTitle}>Made in USA</h3>
            <p className={styles.featureDescription}>
              The UK’s best selling grain free ancestral diet. A top seller for
              good reason.
            </p>
          </div>
          ...
          <div className={styles.feature}>
            ...
            <h3 className={styles.featureTitle}>Natural Ingredients</h3>
            <p className={styles.featureDescription}>
              The UK’s best selling grain free ancestral diet. A top seller for
              good reason.
            </p>
          ...
          <div className={styles.feature}>
            <div>
              <Image alt="logo" src={rewards} width={34} height={34} />
            </div>
            <h3 className={styles.featureTitle}>Rewards</h3>
            <p className={styles.featureDescription}>
              The UK’s best selling grain free ancestral diet. A top seller for
              good reason.
            </p>
          ...
          <div className={styles.feature}>
            <div>
              <Image alt="logo" src={fastShipping} width={34} height={34} />
            </div>
          ...
          <div className={styles.feature}>
            <div>
              <Image
                alt="logo"
                src={autoshipDiscounts}
                width={34}
                height={34}
              />
            </div>
            <h3 className={styles.featureTitle}>Autoship Discounts</h3>
            <p className={styles.featureDescription}>
              The UK’s best selling grain free ancestral diet. A top seller for
              good reason.
            </p>
          ...
          <div className={styles.feature}>
            <div>
              <Image alt="logo" src={secure} width={34} height={34} />
            </div>
