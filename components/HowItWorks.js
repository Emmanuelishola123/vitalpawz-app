...
export default function HowItWorks({ width }) {
  return (
      ...
      <div className="container mx-auto flex flex-col sm:flex-row-reverse">
        <div className="text-center hidden md:flex md:text-left md:w-1/2 md:pl-10 md:relative">
          <div className={styles.image}>
            <Image alt="logo" src={bgImage} />
          </div>
          <div className={styles.image2}>
            <Image alt="logo" src={textBubble} />
          </div>
        </div>
            ...
            <div className={styles.feature}>
              ...
              <div>
                ...
                <p className={styles.featureText}>
                  The UK’s best selling grain free ancestral diet. A top seller for good reason. The UK’s best selling
                  grain free ancestral diet. A top seller for good reason.
                </p>
              </div>
            </div>
