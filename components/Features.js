    ...
    <div className={styles.wrapper}>
      <div className={styles.features}>
        <div className={styles.feature}>
          <Image
            alt="logo"
            src={fastShippingIcon}
            height={25}
            width={25}
            className={styles.icon}
          />
          <p className={styles.description}>Fast shipping</p>
        </div>
        <div className={styles.feature}>
          <Image
            alt="logo"
            ...
            className={styles.icon}
          />
          <p className={styles.description}>Secure payments</p>
        </div>
        <div className={styles.feature}>
          <Image
            alt="logo"
            src={naturalIngredientsIcon}
            height={25}
            width={25}
            className={styles.icon}
          />
          <p className={styles.description}>Natural ingredients</p>
        </div>
        <div className={styles.feature}>
          <Image
            alt="logo"
            ...
            className={styles.icon}
          />
          <p className={styles.description}>Made in USA</p>
        </div>
      </div>
    </div>
  );
