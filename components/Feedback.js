  ...
  return (
    <div className={styles.wrapper}>
      <div className="container mx-auto">
        <h2 className={styles.heading}>Pet Parent Reviews</h2>
        ...
        <div className={styles.feedbacks}>
          <div className={styles.feedback}>
            <div className={styles.feedbackAvatar}>
              <Image
                alt="logo"
                src="/img/feedbacks/avatar-1@2x.webp"
                width={69}
                height={69}
              />
            </div>
            ...
            <p className={styles.feedbackText}>
              I bought all three I love them and would buy again. They grey one
              I think is made out of better Material. But overall I would buy
              again
            </p>
            <p className={styles.feedbackAuthor}>- Julia Sandoval</p>
          </div>
          ...
          <div className={styles.feedback}>
            <div className={styles.feedbackAvatar}>
              <Image
                alt="logo"
                src="/img/feedbacks/avatar-2@2x.webp"
                width={69}
                height={69}
              />
            </div>
          ...
          <div className={styles.feedback}>
            <div className={styles.feedbackAvatar}>
              <Image
                alt="logo"
                src="/img/feedbacks/avatar-3@2x.webp"
                width={69}
                height={69}
              />
            </div>
