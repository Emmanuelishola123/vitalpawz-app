    ...
    <div className={styles.wrapper}>
      <div className="container mx-auto">
        <p className={styles.disclaimer}>
          <span className="font-bold">Disclaimer</span>: These statements have not been evaluated by the U.S. Food and
          Drug Administration. These products are not intended to diagnose, treat, cure, or prevent any disease.
          Information contained or made available through the VitalPawz website is not intended to constitute or
          substitute for legal advice or veterinary advice. Read our policy on blogs and reviews.
        </p>
